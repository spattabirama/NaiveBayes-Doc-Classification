...
def calculate_performance(pos_test_prob, neg_test_prob):
...
def naive_bayes():
	...
	if use_posterior:
		pos_test_prob = calculate_test_prob(pos_test, pos_doc_prob, neg_doc_prob, pos_vocab_prob, neg_vocab_prob, laplace, False)
		neg_test_prob = calculate_test_prob(neg_test, pos_doc_prob, neg_doc_prob, pos_vocab_prob, neg_vocab_prob, laplace, False)
		print("Using Posterior Probabilities:")
		calculate_performance(pos_test_prob, neg_test_prob)

	if use_log:
		pos_test_prob = calculate_test_prob(pos_test, pos_doc_prob, neg_doc_prob, pos_vocab_prob, neg_vocab_prob, laplace, True)
		neg_test_prob = calculate_test_prob(neg_test, pos_doc_prob, neg_doc_prob, pos_vocab_prob, neg_vocab_prob, laplace, True)
